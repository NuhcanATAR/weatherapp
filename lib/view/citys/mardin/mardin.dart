...
class mardinWeatherScreen extends StatefulWidget {
  const mardinWeatherScreen({super.key});

  @override
  State<mardinWeatherScreen> createState() => _mardinWeatherScreenState();
}

// ignore: camel_case_types
class _mardinWeatherScreenState extends State<mardinWeatherScreen> {
  String mardinCity = "";
  ...
  String buildWeatherListMardinText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weathermardinList.isEmpty) {
      ...
      String durum = weathermardinList[0].description;
      String sonuc = "";
                                    ...
                                    FadeInUp(
                                      child: SizedBox(
                                        width:
                                            MediaQuery.of(context).size.width,
                                        child: Text(
                                          "${double.parse(weathermardinList[0].degree).round().toString()}°C",
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weathermardinList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
