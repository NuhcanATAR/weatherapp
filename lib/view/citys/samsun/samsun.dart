...
class samsunWeatherScreen extends StatefulWidget {
  const samsunWeatherScreen({super.key});

  @override
  State<samsunWeatherScreen> createState() => _samsunWeatherScreenState();
}

// ignore: camel_case_types
class _samsunWeatherScreenState extends State<samsunWeatherScreen> {
  String samsunCity = "";
  ...
  String buildWeatherListSamsunText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherSamsunList.isEmpty) {
      ...
      String durum = weatherSamsunList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherSamsunList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
