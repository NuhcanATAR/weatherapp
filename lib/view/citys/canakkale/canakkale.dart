...
class canakkaleWeatherScreen extends StatefulWidget {
  const canakkaleWeatherScreen({super.key});

  @override
  State<canakkaleWeatherScreen> createState() => _canakkaleWeatherScreenState();
}

// ignore: camel_case_types
class _canakkaleWeatherScreenState extends State<canakkaleWeatherScreen> {
  ...
  String buildWeatherListCanakkaleText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weathercanakkaleList.isEmpty) {
      ...
      String durum = weathercanakkaleList[0].description;
      String sonuc = "";
                                                        ...
                                                        child: Container(
                                                          ...
                                                          padding:
                                                              const EdgeInsets
                                                                  .all(2),
                                                          child: Text(
                                                            buildWeatherListCanakkaleText(
                                                                weathercanakkaleList[
                                                                        index +
                                                                            1]
                                                                    .day),
                                                            style: GoogleFonts
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weathercanakkaleList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
