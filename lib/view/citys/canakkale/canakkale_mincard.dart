...
// ignore: camel_case_types
class canakkaleMinCard extends StatefulWidget {
  const canakkaleMinCard({super.key});

  @override
  State<canakkaleMinCard> createState() => _canakkaleMinCardState();
}

// ignore: camel_case_types
class _canakkaleMinCardState extends State<canakkaleMinCard> {
  ...
  Widget build(BuildContext context) {
    if (weathercanakkaleList.isEmpty) {
      return errorLoadinScreen;
    } else {
      return canakkaleMinCardWidget;
    }
  }

  // error & loading screen
  Widget get errorLoadinScreen => SizedBox(
  ...
  // çanakkale min card widget
  Widget get canakkaleMinCardWidget => Card(
        color: Colors.white,
