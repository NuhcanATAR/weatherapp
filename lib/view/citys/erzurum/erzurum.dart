...
class erzurumWeatherScreen extends StatefulWidget {
  const erzurumWeatherScreen({super.key});

  @override
  State<erzurumWeatherScreen> createState() => _erzurumWeatherScreenState();
}

// ignore: camel_case_types
class _erzurumWeatherScreenState extends State<erzurumWeatherScreen> {
  String erzurumCity = "";
  ...
  String buildWeatherListErzurumText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weathererzurumList.isEmpty) {
      ...
      String durum = weathererzurumList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weathererzurumList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
