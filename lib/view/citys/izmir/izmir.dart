...
class izmirWeatherScreen extends StatefulWidget {
  const izmirWeatherScreen({super.key});

  @override
  State<izmirWeatherScreen> createState() => _izmirWeatherScreenState();
}

// ignore: camel_case_types
class _izmirWeatherScreenState extends State<izmirWeatherScreen> {
  String izmirCity = "";
  ...
  String buildWeatherListizmirText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherizmirList.isEmpty) {
      ...
      String durum = weatherizmirList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherizmirList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
