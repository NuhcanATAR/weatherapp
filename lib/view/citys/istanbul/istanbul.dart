...
class istanbulWeatherScreen extends StatefulWidget {
  const istanbulWeatherScreen({super.key});

  @override
  State<istanbulWeatherScreen> createState() => _istanbulWeatherScreenState();
}

// ignore: camel_case_types
class _istanbulWeatherScreenState extends State<istanbulWeatherScreen> {
  String istanbulCity = "";
  ...
  String buildWeatherLististanbulText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatheristanbulList.isEmpty) {
      ...
      String durum = weatheristanbulList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatheristanbulList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
