...
class antalyaWeatherScreen extends StatefulWidget {
  const antalyaWeatherScreen({super.key});

  @override
  State<antalyaWeatherScreen> createState() => _antalyaWeatherScreenState();
}

// ignore: camel_case_types
class _antalyaWeatherScreenState extends State<antalyaWeatherScreen> {
  String antalyaCity = "";
  ...
  String buildWeatherListantalyaText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherantalyaList.isEmpty) {
      ...
      String durum = weatherantalyaList[0].description;
      String sonuc = "";
                                    ...
                                    FadeInUp(
                                      child: SizedBox(
                                        width:
                                            MediaQuery.of(context).size.width,
                                        child: Text(
                                          "${double.parse(weatherantalyaList[0].degree).round().toString()}°C",
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherantalyaList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
