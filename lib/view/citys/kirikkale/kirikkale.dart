...
class kirikkaleWeatherScreen extends StatefulWidget {
  const kirikkaleWeatherScreen({super.key});

  @override
  State<kirikkaleWeatherScreen> createState() => _kirikkaleWeatherScreenState();
}

// ignore: camel_case_types
class _kirikkaleWeatherScreenState extends State<kirikkaleWeatherScreen> {
  ...
  String buildWeatherListKirikkaleText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherKirikkaleList.isEmpty) {
      ...
      String durum = weatherKirikkaleList[0].description;
      String sonuc = "";
                                                        ...
                                                        child: Container(
                                                          ...
                                                          padding:
                                                              const EdgeInsets
                                                                  .all(2),
                                                          child: Text(
                                                            buildWeatherListKirikkaleText(
                                                                weatherKirikkaleList[
                                                                        index +
                                                                            1]
                                                                    .day),
                                                            style: GoogleFonts
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherKirikkaleList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
  ...
  Widget get errorLaodingScreen => Scaffold(
        body: Center(
          child: Column(
