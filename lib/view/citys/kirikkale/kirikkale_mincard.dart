...
// ignore: camel_case_types
class kirikkaleMinCard extends StatefulWidget {
  const kirikkaleMinCard({super.key});

  @override
  State<kirikkaleMinCard> createState() => _kirikkaleMinCardState();
}

// ignore: camel_case_types
class _kirikkaleMinCardState extends State<kirikkaleMinCard> {
  ...
  // kırıkkale min card widget
  Widget get kirikkaleMinCardWidget => Card(
        color: Colors.white,
