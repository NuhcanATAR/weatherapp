...
class corumWeatherScreen extends StatefulWidget {
  const corumWeatherScreen({super.key});

  @override
  State<corumWeatherScreen> createState() => _corumWeatherScreenState();
}

// ignore: camel_case_types
class _corumWeatherScreenState extends State<corumWeatherScreen> {
  String corumCity = "";
  ...
  String buildWeatherListCorumText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherCorumList.isEmpty) {
      ...
      String durum = weatherCorumList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherCorumList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
