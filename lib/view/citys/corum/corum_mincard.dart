...
// ignore: camel_case_types
class corumMinCard extends StatefulWidget {
  const corumMinCard({super.key});

  @override
  State<corumMinCard> createState() => _corumMinCardState();
}

// ignore: camel_case_types
class _corumMinCardState extends State<corumMinCard> {
  String corumCity = "";
  ...
  // çorum min card widget
  Widget get corumMinCardWidget => Card(
        color: Colors.white,
