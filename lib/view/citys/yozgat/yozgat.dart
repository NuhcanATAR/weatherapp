...
class yozgatWeatherScreen extends StatefulWidget {
  const yozgatWeatherScreen({super.key});

  @override
  State<yozgatWeatherScreen> createState() => _yozgatWeatherScreenState();
}

// ignore: camel_case_types
class _yozgatWeatherScreenState extends State<yozgatWeatherScreen> {
  String yozgatCity = "";
  ...
  String buildWeatherListYozgatText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatheryozgatList.isEmpty) {
      ...
      String durum = weatheryozgatList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatheryozgatList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
