...
// ignore: camel_case_types
class yozgatMinCard extends StatefulWidget {
  const yozgatMinCard({super.key});

  @override
  State<yozgatMinCard> createState() => _yozgatMinCardState();
}

// ignore: camel_case_types
class _yozgatMinCardState extends State<yozgatMinCard> {
  String yozgatCity = "";
  ...
  // yozgat min card widget
  Widget get yozgatMinCardWidget => Card(
        color: Colors.white,
