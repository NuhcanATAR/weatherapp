...
class karsWeatherScreen extends StatefulWidget {
  const karsWeatherScreen({super.key});

  @override
  State<karsWeatherScreen> createState() => _karsWeatherScreenState();
}

// ignore: camel_case_types
class _karsWeatherScreenState extends State<karsWeatherScreen> {
  String karsCity = "";
  ...
  String buildWeatherListKarsText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherkarsList.isEmpty) {
      ...
      String durum = weatherkarsList[0].description;
      String sonuc = "";
                                ...
                                builder: (context) => SizedBox(
                                      ...
                                      child: Padding(
                                        ...
                                        child: ListView.separated(
                                          itemCount: weatherkarsList.length - 1,
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherkarsList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
