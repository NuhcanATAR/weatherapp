...
class konyaWeatherScreen extends StatefulWidget {
  const konyaWeatherScreen({super.key});

  @override
  State<konyaWeatherScreen> createState() => _konyaWeatherScreenState();
}

// ignore: camel_case_types
class _konyaWeatherScreenState extends State<konyaWeatherScreen> {
  String konyaCity = "";
  ...
  String buildWeatherListKonyaText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weatherKonyaList.isEmpty) {
      ...
      String durum = weatherKonyaList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weatherKonyaList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
