...
class trabzonWeatherScreen extends StatefulWidget {
  const trabzonWeatherScreen({super.key});

  @override
  State<trabzonWeatherScreen> createState() => _trabzonWeatherScreenState();
}

// ignore: camel_case_types
class _trabzonWeatherScreenState extends State<trabzonWeatherScreen> {
  String trabzonCity = "";
  ...
  String buildWeatherListTrabzonText(String day) {
  ...
  Widget build(BuildContext context) {
    ...
    if (weathertrabzonList.isEmpty) {
      ...
      String durum = weathertrabzonList[0].description;
      String sonuc = "";
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: <Widget>[
                                                              Flexible(
                                                                ...
                                                                flex: 1,
                                                                child: Text(
                                                                  "${double.parse(weathertrabzonList[index + 1].min).round()}°",
                                                                  style:
                                                                      GoogleFonts
                                                                          .nunito(
                                                                    textStyle: Theme.of(
